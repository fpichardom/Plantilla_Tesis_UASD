...
\DefineBibliographyStrings{spanish}{andothers={et~al\adddot},bibliography={Literatura Citada}}
\DeclareFieldFormat[article,inbook,incollection,inproceedings,patent,thesis,unpublished]{title}{#1\isdot}
\renewbibmacro{in:}{%
  \ifentrytype{article}{}{\printtext{\bibstring{in}\intitlepunct}}}
\DeclareDelimFormat[cbx@textcite]{nameyeardelim}{\addspace} % se necesita para compensar un bug de algunas versiones de biblatex donde cita de la manera autor, (año) en lugar de autor (año).
\DeclareFieldFormat[article]{journaltitle}{\textrm{#1}}
